...
Round_box=PhotoImage(file="assets/shape1.png")
Label(root,image=Round_box,bg="#57adff").place(x=30,y=110)
label1=Label(root,text="Temperature",font=('Consolas',11),fg="white",bg="#203243")
label1.place(x=50,y=120)

label2=Label(root,text="Humidity",font=('Consolas',11),fg="white",bg="#203243")
label2.place(x=50,y=140)

label3=Label(root,text="Pressure",font=('Consolas',11),fg="white",bg="#203243")
label3.place(x=50,y=160)

label4=Label(root,text="Wind Speed",font=('Consolas',11),fg="white",bg="#203243")
label4.place(x=50,y=180)

label5=Label(root,text="Description",font=('Consolas',11),fg="white",bg="#203243")
label5.place(x=50,y=200)

Search_image=PhotoImage(file="assets/shape3.png")
myimage=Label(image=Search_image,bg="#57adff")
myimage.place(x=270,y=120)

weat_image=PhotoImage(file="assets/Layer 7.png")
...
textfield.focus()
Search_icon=PhotoImage(file="assets/Layer 6.png")
...
firstbox=PhotoImage(file="assets/shape2g.png")
secondbox=PhotoImage(file="assets/shape2v.png")
...
clock=Label(root,font=("Consolas",30,'bold'),fg="white",bg="#57adff")
clock.place(x=30,y=20)
timezone=Label(root,font=("Consolas",20),fg="white",bg="#57adff")
timezone.place(x=700,y=20)
long_lat=Label(root,font=("Consolas",10),fg="white",bg="#57adff")
long_lat.place(x=700,y=50)

t=Label(root,font=("Consolas",10),fg="white",bg="#203243")
t.place(x=150,y=120)
h=Label(root,font=("Consolas",10),fg="white",bg="#203243")
h.place(x=150,y=140)
p=Label(root,font=("Consolas",10),fg="white",bg="#203243")
p.place(x=150,y=160)
w=Label(root,font=("Consolas",10),fg="white",bg="#203243")
w.place(x=150,y=180)
d=Label(root,font=("Consolas",10),fg="white",bg="#203243")
d.place(x=150,y=200)
...
day1temp = Label(firstframe,bg="#282829",fg="#57adff",font="Consolas 15 bold")
